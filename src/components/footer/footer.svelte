...
<div class='flex bg-black p-5 block lg:mt-5 w-full 2xl:justify-between 2xl:flex-row flex-col text-white '>
  <div >
    ...
    {#if loadedGodot}
      <p><a href='https://godotengine.org/' target='_blank' rel='noreferrer' class='hover:underline dark:text-red-300 text-blue-300'>Godot</a> is licensed under <a href='https://godotengine.org/license/' target='_blank' rel='noreferrer' class='hover:underline dark:text-red-300 text-blue-300'>the MIT license</a>.</p>
    {/if}
  </div>
