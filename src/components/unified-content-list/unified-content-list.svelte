        ...
        >
          {#if contentItem.ghStars > 0}
            <a
              ...
              class='hover:underline pr-[10px] inline-block align-top hover:underline p-[7px] bg-zinc-200 dark:bg-zinc-700 dark:text-white rounded-xl mr-3 mb-2 mt-2 inline-block max-h-[110px] sm:top-0 sm:right-0 sm:relative absolute top-2 right-2'
            >
